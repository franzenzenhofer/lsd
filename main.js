...
(function() {
  ...
  _BUTTONSTYLE_.innerText = '#surrender_button { font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol"; display: inline-block; position: relative; color: #494949 !important; text-transform: uppercase; text-decoration: none; background: white; padding: 10px; border: 0px solid #494949 !important; display: inline-block; transition: all 0.4s ease 0s; }';
